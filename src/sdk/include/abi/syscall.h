...
//              (see abi/errno.h for the numbers).
//
// The numbers below are transitional: the next step renumbers them to the
// Linux x86_64 values and moves SurfaceOS-only calls to 0x1000+.

#define SYS_EXIT            0   // (code)

#define SYS_WRITE           1   // (str) - NUL-terminated, screen + uart
...
#define SYS_READ_DIR        9   // (path, dir_entry_t*, max_entries)
